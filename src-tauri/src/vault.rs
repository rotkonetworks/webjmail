...
/// Reveal a file in the OS file manager (Finder / Explorer / the Linux file
/// manager), selecting it. Safer than opening the file itself: it never hands
/// an attacker-named attachment to a default handler, it just shows where it
/// landed so the user can decide what to do with it.
#[tauri::command]
